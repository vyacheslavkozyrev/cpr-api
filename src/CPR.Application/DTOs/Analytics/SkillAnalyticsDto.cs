...
namespace CPR.Application.DTOs.Analytics
{
    ...
    public record SkillHistoryEntryDto
    {
        ...
        [JsonProperty("self_assessment_value")]
        ...
        [JsonProperty("manager_assessment_value")]
    ...
    public record SkillRowDto
    {
        ...
        [JsonProperty("current_self_assessment")]
        ...
        [JsonProperty("current_manager_assessment")]
    ...
    public record GapClosureSummaryDto
    {
        ...
        [JsonProperty("gaps_closed_in_period")]
        ...
        [JsonProperty("gaps_worsened_in_period")]
        ...
        [JsonProperty("avg_gap_at_period_start")]
        ...
        [JsonProperty("avg_gap_at_period_end")]
    ...
    public record SkillAnalyticsDto
    {
        ...
        [JsonProperty("gap_closure_summary")]
