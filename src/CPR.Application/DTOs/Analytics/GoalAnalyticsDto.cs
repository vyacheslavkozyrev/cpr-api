...
namespace CPR.Application.DTOs.Analytics
{
    ...
    public record GoalStatsDto
    {
        ...
        [JsonProperty("created_in_period")]
        ...
        [JsonProperty("in_progress_goals")]
        ...
        [JsonProperty("avg_days_to_complete")]
