...
- [ ] Iteration 5 — EF Core: Relation tables
  ...
  - Notes: Several relation tables (e.g., `goal_tasks`, `feedback`, `feedback_requests`) were implemented in Iteration 4; the three tables above remain to complete the relation layer and are the primary scope for Iteration 5.
